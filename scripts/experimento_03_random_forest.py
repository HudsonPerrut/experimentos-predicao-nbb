...
import time
import numpy as np
from random_forest import run_model_random_forest
...
def run_models(data_dir):
    ...
    for treino_file, teste_file in zip(treino_files, teste_files):
        ...
        acuracia, f1, best_params = run_model_random_forest(treino_path, teste_path, True)
...
if __name__ == '__main__':
    ...
    for jogos_base in [5, 10, 15]:
        ...
        for temporada in temporadas:
            ...
            print(f'[Random Forest] K={jogos_base} | {temporada} → Acurácia: {media_acuracia:.4f}')
